...
<head>
	...
	<link rel="stylesheet" href="_code/css/reset.css"> <!-- CSS reset -->
	<link rel="stylesheet" href="_code/css/style.css"> <!-- Resource style -->
...
<body>
	...
	<header>
		<div class="cd-logo"><a href="#0"><img src="_images/logosp.png" alt="Logo"></a></div>

		<nav class="cd-main-nav-wrapper">
			<ul class="cd-main-nav">
				<li><a href="#0">Home</a></li>
				<li><a href="_sections/development.aspx">Development</a></li>
				<li>
					<a href="#0" class="cd-subnav-trigger"><span>Your Tools</span></a>

					<ul>
						<li class="go-back"><a href="#0">Menu</a></li>
						<li><a href="#0">On the Phone</a></li>
                        <li><a href="#0">Know the Numbers</a></li>
						<li><a href="#0">Blue Benefits</a></li>
						<li><a href="#0">AMEX</a></li>
			...
			<li class="visible">
				<div class="cd-svg-wrapper">
					<svg viewBox="0 0 1400 800">
						...
						<image height='800px' width="1400px" clip-path="url(#cd-image-1)" xlink:href="_images/gallery/Slide1.png"></image>
					</svg>
				</div> <!-- .cd-svg-wrapper -->
			</li>
			...
			<li>
				<div class="cd-svg-wrapper">
					<svg viewBox="0 0 1400 800">
						...
						<image height='800px' width="1400px" clip-path="url(#cd-image-2)" xlink:href="_images/gallery/Slide2.png"></image>
					</svg>
				</div> <!-- .cd-svg-wrapper -->
			</li>
			...
			<li>
				<div class="cd-svg-wrapper">
					<svg viewBox="0 0 1400 800">
						...
						<image height='800px' width="1400px" clip-path="url(#cd-image-3)" xlink:href="_images/gallery/Slide3.png"></image>
					</svg>
				</div> <!-- .cd-svg-wrapper -->
			</li>
			...
			<li>
				<div class="cd-svg-wrapper">
					<svg viewBox="0 0 1400 800">
						...
						<image height='800px' width="1400px" clip-path="url(#cd-image-4)" xlink:href="_images/gallery/Slide4.png"></image>
					</svg>
				</div> <!-- .cd-svg-wrapper -->
			</li>
